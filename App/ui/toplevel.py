...
class Toplevel:
    ...
    def __init__(self, root: tk.Toplevel, app: "App" = None):
        ...
        self.slider_H.config(
            command=lambda val, var=self.app.hop_length, widget=self.slider_H, widget_entry=self.entry_H: slider_decorator(
        ...
        self.entry_H.bind(
            "<Return>",
            lambda event, var=self.app.hop_length, prev=entry_H_content, widget=self.entry_H, widget_slider=self.slider_H: self.Entry_check(
