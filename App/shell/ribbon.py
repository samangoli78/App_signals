"""Collapsible left ribbon shell — generic widgets only, no app logic."""
...
class RibbonSection(TypedDict):
    """Return value of :func:`~collapsible_section`."""
...
class RibbonShell(TypedDict):
    """Return value of :func:`build_ribbon_shell`."""

    outer_pane: ttk.PanedWindow
